...
echo "🗄️ Setting up Remova database..."
...
heroku pg:psql -a remova-platform -c "
DROP TRIGGER IF EXISTS update_cbp_filings_updated_at ON cbp_filings;
...
echo "🎯 Ready to test signup flows"
