  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        {/* Pricing Plans - ULTRA WIDE LAYOUT */}
        <section className="container mx-auto px-4 py-16">
          ...
          {/* EVEN WIDER GRID - PERFECT FOR MEDIUM SCREENS */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-full mx-auto px-2">
            {plans.map((plan) => (
              <div 
                key={plan.name} 
              ...
              >
                ...
                <div className="card-body p-4 flex flex-col h-full">
                  ...
                  <div className="text-center mb-4">
                    ...
                    <div className="mb-4">
                      <div className="text-3xl font-extrabold text-primary mb-1">{plan.price}</div>
                  ...
                  <div className="space-y-3">
                    {/* Availability */}
                    <div className="w-full bg-warning/10 text-warning px-2 py-2 rounded-lg text-center">
                    ...
                    {/* Guarantee */}
                    {plan.guarantee && (
                      <div className="w-full bg-success/10 text-success px-2 py-2 rounded-lg text-center">
